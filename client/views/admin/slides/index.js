Template.slidesIndex.helpers({
});

Template.slidesIndex.events = {
  ...
  /* sorting by parameter */
  'click #btnSortdate': function(e) {
    MeteorisGridView.sort('date');
  },
  /* sorting by parameter */
  'click #btnSortcontent': function(e) {
    MeteorisGridView.sort('content');
  },
  'click #btnSortisSlide': function(e) {
    MeteorisGridView.sort('isSlide');
  },
